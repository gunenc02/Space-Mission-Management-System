export function getPlatforms(user: { token: string }): Promise<Platform[]> {
  ...
  export function createPlatform(platformDto: any, user: { token: string }): Promise<void> {
  ...
  export function updatePlatform(platformDto: any, user: { token: string }): Promise<void> {
  ...
  export function deletePlatform(id: number, user: { token: string }): Promise<void> {
